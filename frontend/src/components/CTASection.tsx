  ...
  return (
    <section className="py-32 px-8">
      <div className="max-w-5xl mx-auto glass-panel rounded-[32px] p-16 relative overflow-hidden border border-white/10 text-center">
        ...
        <p className="text-[#a7aca9] text-lg max-w-2xl mx-auto mb-12">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
          <button className="px-10 py-5 bg-[#46ff78] text-[#005d23] font-bold rounded-full hover:scale-105 active:scale-95 transition-all shadow-[0_0_20px_rgba(70,255,120,0.3)]">
            Analyze Company
          </button>
